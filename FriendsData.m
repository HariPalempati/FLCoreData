...
@synthesize friendsArray = friendsArray;
...
-(void)getFacebookFriends: (FriendsCallbackSuccess)success error:(FriendsCallbackError)inError
{
    ...
    NSDictionary *FacebookOptions = @{ACFacebookAppIdKey: @"1461810714133689", ACFacebookPermissionsKey: @[@"public_profile",@"email",@"user_friends"],ACFacebookAudienceKey:ACFacebookAudienceFriends};
